...
df_table = {'Token':tokens_words,'Negative': counts[0,:],'Positive': counts[1,:],'Neutral': counts[2,:]}
tokens = pd.DataFrame(df_table, columns= ['Token','Positive','Negative','Neutral'])
# positives = len(tokens[tokens['Positive']>tokens['Negative'] and tokens['Positive'] < tokens['Neutral']])
positives = len(tokens[tokens['Positive']>tokens['Negative']])
print('No. of positive tokens: ',positives)
negative =len(tokens_words)-positives
print('No. of negative tokens: ',negative)
print('No. of neutral tokens: ',negative-positives)
